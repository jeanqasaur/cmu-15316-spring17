...
%token DELEGATION DELEGATE DELETE
...
| SET DELEGATION ID right ARROW principal { Set_delegate ($3, $4, $6) }
| DELETE DELEGATION ID right ARROW principal { Delete_delegate ($3, $4, $6) }
;
